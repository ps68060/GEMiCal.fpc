...
CONST
    ...
    M_INFO                           =   7; (* STRING in tree Tree000 *)
    M_FOLDER                         =  16; (* STRING in tree Tree000 *)
    M_DIALOG                         =  17; (* STRING in tree Tree000 *)
    M_CALENDAR                       =  18; (* STRING in tree Tree000 *)
    M_END                            =  19; (* STRING in tree Tree000 *)
